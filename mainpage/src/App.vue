<template>
    <div>
        <el-card class="box-card">
            ...
            <el-form label-position="right" label-width="100px" class="main">
                ...
                <el-form-item label="使用代理">
                    <el-switch v-model="proxy_switch" active-text="关闭后将直接获取规则集而非通过本服务器代理"></el-switch>
                </el-form-item>
        ...
        <div class="footer">
            <div>
                <img src="https://s.ssss.fun/ICON/CNYZ/logo-1.svg" alt="中國遠徵" width="108" height="28">
                <br>
                <font color="#999" size="1">Copyright © <script>document.write(new Date().getFullYear());</script>2024<b> 中國遠徵 </b>All rights reserved</font>
            </div>
        </div>
    </div>
</template>
